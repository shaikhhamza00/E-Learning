...
public class FrameStdenrol extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FrameStdenrol frame = new FrameStdenrol();
...
//				String query="Select course_id from enroll where ins_id='"+f.lblid.getText()+"'";
...
//			}
		...
		lblNewLabel_2_1_5_1.setBounds(86, 22, 189, 28);
		...
		pnlbtn_1_4.addMouseListener(new MouseAdapter() {
			...
			@Override
			public void mouseExited(MouseEvent e) {
				pnlbtn_1_4.setBackground(Color.white);
				lblNewLabel_2_1_5_1.setForeground(Color.black);
			}
		...
		download6.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					...
					Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/lms","root","root");
					Statement st=con.createStatement();
					String query="select e.logid,concat(s.stdfirstname,' ',s.stdlastname) as 'Full Name',s.stdemail from std_enrol e join student s on e.logid=s.logid and e.course_id='"+course_id.getText()+"'";
		...
		download6_1.setBounds(777, 11, 151, 56);
		...
		JLabel lblNewLabel_2_1_5_5_1_5_1 = new JLabel("Clear");
		lblNewLabel_2_1_5_5_1_5_1.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				table.setModel(new DefaultTableModel());
			}
